...
path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_DE/output/DE/LSTM/"
...
# Load models
    if  a == 1:
        ...
        path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_DE/output/DE/GRU/"
        df = pd.read_csv(path_in+f'df_dl.csv')
        df1=df[df['classifier'] == 'c1']
        df1.dropna(axis=0, how='any')
        df2=df[df['classifier'] == 'c2']
        ...
        path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_DE/output/DE/BILSTM/"
        df = pd.read_csv(path_in+f'df_dl.csv')
        df1=df[df['classifier'] == 'c1']
        df1.dropna(axis=0, how='any')
        df2=df[df['classifier'] == 'c2']
...
# 设置图形的保存路径
file_path = 'sjt/workspace/beginning_project/cell_change尝试/test_DE/output/DE/combined_pd.png'
# 保存图形到文件
