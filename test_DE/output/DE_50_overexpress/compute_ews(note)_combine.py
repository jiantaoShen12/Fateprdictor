...
# Import PCA data
df = pd.read_csv("/home/sjt/workspace/beginning_project/cellseries/TIGON-main/Output/iPSC_10_overexpress/trajectory_and_pseudotime.csv")
# 检查DataFrame是否为空
if df.empty:
...
for a in range(1,4):
    if  a == 1:
        ...
        c2 = load_model(path)
        output_dir="/home/sjt/workspace/beginning_project/cell_change尝试/test_iPSC/output/iPSC_10_overexpress/LSTM/"
    elif a == 2:
        ...
        c2 = load_model(path)
        output_dir="/home/sjt/workspace/beginning_project/cell_change尝试/test_iPSC/output/iPSC_10_overexpress/GRU/"
    elif a == 3:
        ...
        c2 = load_model(path)
        output_dir="/home/sjt/workspace/beginning_project/cell_change尝试/test_iPSC/output/iPSC_10_overexpress/BILSTM/"
