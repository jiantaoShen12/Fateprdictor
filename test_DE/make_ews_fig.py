...
T=['DE','DE_20_overexpress','DE_30_overexpress','DE_50_overexpress','DE_50_knockout','DE_500_knockout']


T=['DE','DE_20_overexpress','DE_30_overexpress','DE_50_overexpress','DE_50_knockout','DE_200_knockout']
p=3

file_path = f'/home/sjt/workspace/beginning_project/cell_change尝试/test_DE/output/{T[p]}/LSTM/'
path_out = f'/home/sjt/workspace/beginning_project/cell_change尝试/test_DE/output/{T[p]}/'
df = pd.read_csv(file_path+'df_ews.csv')
...
pio.write_image(fig, path_out+'_ews.png')
# 显示保存成功的消息
print(f'Figure1 saved to {path_out}')
fig.show()
...
pio.write_image(fig1, path_out+'_VAR.png')
# 显示保存成功的消息
print(f'Figure2 saved to {path_out}')
fig1.show()
...
pio.write_image(fig2, path_out+'_AC1.png')
# 显示保存成功的消息
print(f'Figure2 saved to {path_out}')
