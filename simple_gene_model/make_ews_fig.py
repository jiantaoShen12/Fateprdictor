...
T=['df_fold_forced_g1','df_fold_forced_g2','df_null','df_pf_forced']
p=0
file_path = f'/home/sjt/workspace/beginning_project/cell_change尝试/simple_gene_model/output/{T[p]}'
df = pd.read_csv(f'/home/sjt/workspace/beginning_project/cell_change尝试/simple_gene_model/output/LSTM/{T[p]}.csv')
