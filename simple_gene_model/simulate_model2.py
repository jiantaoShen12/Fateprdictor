...
# Load models
    ...
    fig.write_html(f'{path_out}ews_pf.html')
    ...
    df_out.to_csv(f'{path_out}df_pf_forced.csv')
    ...
    fig.write_html(f'{path_out}bif_pf.html')

    # Export
    df_plot.dropna(inplace=True)
    df_plot.to_csv(f'{path_out}df_pf_bif.csv', index=False)
    ...
    # fig = ts.make_plotly(ens_avg=True)
    # fig.update_layout(height=650)
    # # fig.write_html('/home/sjt/workspace/beginning_project/cell_change尝试/simple_gene_model/figure/ews_null.html')
    ...
    # df_out.to_csv("/home/sjt/workspace/beginning_project/cell_change尝试/simple_gene_model/output/df_null.csv")
    ...
    # fig = px.line(df_plot, x="m1", y="value", color="variable")
    # # fig.write_html('/home/sjt/workspace/beginning_project/cell_change尝试/simple_gene_model/figure/bif_null.html')

    # # Export
    # df_plot.dropna(inplace=True)
    # df_plot.to_csv("/home/sjt/workspace/beginning_project/cell_change尝试/simple_gene_model/output/df_null_bif.csv", index=False)
