...
# Load models
    ...
    fig.write_html(f'{path_out}ews_null.html')
    ...
    df_out.to_csv(f'{path_out}df_null.csv')
    ...
    fig.write_html(f'{path_out}bif_null.html')

    # Export
    df_plot.dropna(inplace=True)
    df_plot.to_csv(f'{path_out}df_null_bif.csv', index=False)
