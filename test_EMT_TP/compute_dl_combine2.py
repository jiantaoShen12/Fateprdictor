...
#df_dl_fixed1  df_dl_null_fixed1
path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/LSTM/"
...
# Load models
    if  a == 1:
        path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/LSTM/"
        df = pd.read_csv(path_in+f'df_dl_fixed.csv')
        df1=df[df['classifier'] == 'm1']
        df1.dropna(axis=0, how='any')
        ...
        path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/GRU/"
        df = pd.read_csv(path_in+f'df_dl_fixed.csv')
        df1=df[df['classifier'] == 'm1']
        df1.dropna(axis=0, how='any')
        df2=df[df['classifier'] == 'm2']
        ...
        path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/BILSTM/"
        df = pd.read_csv(path_in+f'df_dl_fixed.csv')
        df1=df[df['classifier'] == 'm1']
        df1.dropna(axis=0, how='any')
        df2=df[df['classifier'] == 'm2']
...
# 保存到CSV文件，不保留索引
dl.to_csv('sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/df_dl_fixed.csv', index=False)# name1=['Null', 'Fold', 'Ts', 'Pf', 'Pd', 'Ns']
...
# # 设置图形的保存路径
# file_path = 'sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/gigure.png'
# # 保存图形到文件
