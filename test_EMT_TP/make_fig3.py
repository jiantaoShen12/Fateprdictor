...
#df_dl_forced = pd.read_csv("/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/LSTM/df_dl_pd_fixed.csv")
fig_roc = make_roc_figure(df_roc, "f", text_N="N={}".format(len(df_dl_forced) * 2))
fig_roc.write_image("/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/temp_roc.png", scale=scale)
make_inset_boxplot(df_dl_forced, "PD", "/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/temp_inset.png")

path_roc = "/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/temp_roc.png"
path_inset = "/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/temp_inset.png"
path_out = "/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/roc_heart.png"
combine_roc_inset(path_roc, path_inset, path_out)


df_roc = pd.read_csv("sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/对比1/df_roc.csv")
df_dl_forced = pd.read_csv("sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/对比1/df_dl_fixed.csv")
fig_roc = make_roc_figure(df_roc, "f", text_N="N={}".format(len(df_dl_forced) * 2))
fig_roc.write_image("sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/对比1/temp_roc.png", scale=scale)
make_inset_boxplot(df_dl_forced, "PD", "sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/对比1/temp_inset.png")

path_roc = "sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/对比1/temp_roc.png"
path_inset = "sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/对比1/temp_inset.png"
path_out = "sjt/workspace/beginning_project/cell_change尝试/test_EMT_TP/output/对比1/roc_heart.png"
combine_roc_inset(path_roc, path_inset, path_out)