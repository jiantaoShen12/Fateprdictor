...
# Import PCA data
df = pd.read_csv("/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT/EMT.csv")
# 检查DataFrame是否为空
if df.empty:
...
# 执行比较
transition = len(df_select[df_select["Pseudotime"] <= 0.2*T])
print(transition)
...
print(df_select)
#T AE_EMT_3weidf = pd.read_csv("/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT/EMT.csv")
for a in range(1,4):
    if  a == 1:
        ...
        c2 = load_model(path)
        output_dir=f"/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT/output/{T}/LSTM/"
    elif a == 2:
        ...
        c2 = load_model(path)
        output_dir=f"/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT/output/{T}/GRU/"
    elif a == 3:
        ...
        c2 = load_model(path)
        output_dir=f"/home/sjt/workspace/beginning_project/cell_change尝试/test_EMT/output/{T}/BILSTM/"
