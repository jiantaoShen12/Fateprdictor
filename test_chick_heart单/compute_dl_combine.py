...
path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_chick_heart单/output/BILSTM/"
df = pd.read_csv(path_in+f'df_dl_{tsid}.csv')
...
# Load models
    if  a == 1:
        path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_chick_heart单/output/LSTM/"
        df = pd.read_csv(path_in+f'df_dl_{tsid}.csv')
        df1=df[df['classifier'] == 'c1']
        df1.dropna(axis=0, how='any')
        ...
        path_in="/home/sjt/workspace/beginning_project/cell_change尝试/test_chick_heart单/output/GRU/"
        df = pd.read_csv(path_in+f'df_dl_{tsid}.csv')
        df1=df[df['classifier'] == 'c1']
        df1.dropna(axis=0, how='any')
        df2=df[df['classifier'] == 'c2']
...
# 设置图形的保存路径
file_path = f'/home/sjt/workspace/beginning_project/cell_change尝试/test_chick_heart单/output/combined_{tsid}.png'
# 保存图形到文件
