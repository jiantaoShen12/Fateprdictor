...
file_path = f'/home/sjt/workspace/beginning_project/cell_change尝试/test_chick_heart单/output/LSTM/'
path_out = f'/home/sjt/workspace/beginning_project/cell_change尝试/test_chick_heart单/output/{tsid}'
df = pd.read_csv(file_path+F'df_ews_{tsid}.csv')
